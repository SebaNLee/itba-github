...
public class TesterAeropuerto {
    public static void main(String[] args) {
        ...
        for(Counter counter : airPort.airlineOrderCounters()) { // !!! el método debe detornar un Counter[]
        ...
        }; // obs: esto se hace porque Java no tiene funciones
        // es guardarme la referencia al código, para no meterlo en los () de abajo repetidamente

        // alternativa con lambda:
        Predicate<Counter> idleAndStarsWithA = counter -> !counter.isCheckin() && counter.getAirline().startsWith("A");
