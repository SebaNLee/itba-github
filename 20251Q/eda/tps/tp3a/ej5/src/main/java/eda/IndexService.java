...
public interface IndexService {
    ...
    // imprime el contenido del índice ordenado por su key.
    void sortedPrint();

    // devuelve el máximo elemento del índice. Lanza RuntimeException si no hay elementos
    int getMax();

    // devuelve el mínimo elemento del índice. Lanza RuntimeException si no hay elementos int getMin();
    int getMin();
}
