...
public class CustomTheSearcher {
    ...
    public static void main( String[] args ) {
        ...
        try {
			...
			// Query query= new TermRangeQuery.newStringRange(fieldName, "gaming", "gum", false, false); // ??
			// Query query= new PhraseQuery(fieldName, "video", "game"); // ??
...
// mvn compile && mvn exec:java -Dexec.mainClass="eda.CustomTheSearcher"